...
public class ModRegistry {
    public static final EnchantmentCategory LASSO_ENCHANTMENT_CATEGORY = CommonAbstractions.INSTANCE.createEnchantmentCategory(MobLassos.MOD_NAME.toUpperCase(Locale.ROOT).replace(" ", "_") + "_LASSO", item -> item instanceof LassoItem);
